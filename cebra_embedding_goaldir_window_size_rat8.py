...
def main():    
    ...
    model_dir = os.path.join('/ceph/scratch/jakeo/honeycomb_neural_data/models/', animal, 'window_size_for_goaldir')
    ...
    grid_dir = os.path.join('/ceph/scratch/jakeo/honeycomb_neural_data/models/', animal, 'z_scored_spike_xy_goaldir')
